...
@Composable
fun VisibilityWidget(visibility: Int?, measurementType: MeasurementType?) {
    ...
    WeatherDetailsSurface(
        content = {
            ...
            Text(visibility?.let { stringResource(visibilityInputUnit, it) }
            ...
            Text(stringResource(visibilityUnit),
