...
fun HomeBottomSheetScaffold(state: HomeState) {
    ...
    if (state.shouldShowPermissionsDialog.value) {
        requestLocationPermission(state.locationPermissionsDialog.permissionText, state.locationPermissionsDialog.onDismiss)
    }
